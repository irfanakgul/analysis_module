...
class Analysis():
    ...
    def fn_distribution(self,df,col_a,col_1):
        ...
        # if the investigated colums has an numarical stype, will draw following graph:
        if df[col_1].dtype != 'O':

            # focusing to needed columns
    ...
    def fn_analysis_2(self, df_table1, df_table2,col_1,col_2):
        ...
        # check in config file and draw graphs
    ...
    def fn_main_run(self):
        ...
        # create emtpty df for all results
        ...
        print('<<<< ALL ANALYSIS HAS DONE SUCCESFULY and WRITTEN TO OUTPUT FILE >>>>>>>>>>>')
